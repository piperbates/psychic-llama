...
if(question === null) {
	...
	eightBall = '<img src="http://lazy-bunny.com/images/mug.jpg" alt="mugshot" class="mugshot" /> <p>If you <strong>must</strong> know, they\'re a creative web developer type who likes to test their skills and tinker with new projects.</p> <p>If you ask me (which, I note, you are), they have a very silly sense of humour - which you have probably surmised by visiting this particular area of the internet.</p><p> If you really want to know more I suppose you could visit <a href="http://www.lazy-bunny.com" target="_blank">their coding portfolio</a>. However, you might be more interested in their <a href="http://www.sarahandthestrange.com" target="_blank">illustration stuff</a>, if you like that sort of thing.</p> '
